import time
from need import NOBODY_CAR_URL, CAR_NUMBER,BASE_DIR,check_nobodycar_status,check_nobodycar_status_ws
import os
import subprocess
import json
...
def restart_nobodycar():
    ...
    while True:
        ...
        check_nobodycar_status_ws(NOBODY_CAR_URL,CAR_NUMBER,the_type='end')
